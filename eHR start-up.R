...
import_CPRD_data(db, data_dir = ehr_path,         
                 filetypes = c("Therapy_001_Cut2", "Therapy_002_Cut2", "Therapy_003_Cut2", "Therapy_004_Cut2"),
                 dateformat = "%d/%m/%Y",
                 yob_origin = 1800,
...
import_CPRD_data(db, data_dir = ehr_path,         
                 filetypes = c("Common_Dosages","Prodcodes_Cut", "Referral_001", "Patient_001", "Clinical_001_Cut3", "Clinical_002_Cut3", "Clinical_003_Cut3", "MedicalReadcodes", "MedicalProdcodes", "prod_pd_treat", "Practice_001"),
                 dateformat = "%d/%m/%Y",
                 yob_origin = 1800,
                 regex = "PD_immunosup_Extract",
                 recursive = TRUE)
